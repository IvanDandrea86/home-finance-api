...
@InputType()
export class ExpenseUpdateManyWithoutFamilyNestedInput {
    ...
    @Field(() => [ExpenseUpsertWithWhereUniqueWithoutFamilyInput], {nullable:true})
    ...
    @Field(() => [ExpenseUpdateWithWhereUniqueWithoutFamilyInput], {nullable:true})
    @Type(() => ExpenseUpdateWithWhereUniqueWithoutFamilyInput)
    update?: Array<ExpenseUpdateWithWhereUniqueWithoutFamilyInput>;

    @Field(() => [ExpenseUpdateManyWithWhereWithoutFamilyInput], {nullable:true})
